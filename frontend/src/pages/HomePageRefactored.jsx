// Refactored HomePage - Demonstrating enhanced UI components from Phase 1+2
...
export default function HomePageRefactored() {
  ...
  return (
    <>
      {/* Hero Section with gradient variant */}
      <SectionHero
        variant="gradient"
        size="lg"
        title="Welcome to Kelsey's Cats"
        subtitle="Finding loving homes for cats in need. Every cat deserves a second chance."
        actions={
          <>
      ...
      <Section $padding="lg">
        <Container $size="md">
          ...
          <CardText style={{ textAlign: 'center', fontSize: '1.125rem' }}>
            ...
            their forever family. Thank you for considering adoption!
          </CardText>
